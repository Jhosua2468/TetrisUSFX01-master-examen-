...
void ABoard::Tick(float DeltaTime)
{
    ...
    case PS_GOT_BOTTOM:
        ...
        if (CoolLeft <= 0.0f)
        {
            ...
            //Campbia el tipo de pieza
            NextPieceType = GetRandomPieceType(); // GetRandomPieceType() es una funcion q devuelve un tipo de pieza aleatorio

            // Crea una pieza con el nuevo tipo
