...
float APiece::GetRandomPieceType()
{
    // Array with all the possible piece types
    const TArray<int32> PieceTypes = { {{-20.0, 0.0}, {-10.0, 0.0}, {0.0, 0.0}, {10.0, 0.0}},
        {{0.0, 10.0}, {0.0, 0.0}, {10.0, 0.0}, {20.0, 0.0}},
        {{-20.0, 0.0}, {-10.0, 0.0}, {0.0, 0.0}, {0.0, 10.0}},
        {{0.0, 0.0}, {10.0, 0.0}, {0.0, -10.0}, {10.0, -10.0}},
        {{-10.0, -10.0}, {0.0, -10.0}, {0.0, 0.0}, {10.0, 0.0}},
    ...
    const float RandomIndex = FMath::RandRange(0, PieceTypes.Num() - 1);

    // Return the piece type at the random index
